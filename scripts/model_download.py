...
#         data_size = round(int(response.headers["Content-Length"]) / 1024 / 1024)
...
#     parser.add_argument("--repo_type", default="model", type=str, required=False)  # models,dataset
...
# huggingface_hub.login("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")
snapshot_download('Qwen/Qwen2-7B-Instruct', local_dir='/home/jovyan/zhubin/DATA/models/Qwen2-7B-Instruct',
etag_timeout=120, resume_download=True, local_dir_use_symlinks=False)
# huggingface_hub.login("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")
# snapshot_download('openai-community/gpt2', local_dir='/home/jovyan/zh/benchmark/pretrain_model/test',
# etag_timeout=120, resume_download=True)
