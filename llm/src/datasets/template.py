...
class Template:
    ...
    def _format(
        self, query: str, resp: str, history: Optional[List[Tuple[str, str]]] = None, system: Optional[str] = None
    ...
    def _get_special_ids(self, tokenizer: "PreTrainedTokenizer") -> Tuple[List[int], List[int]]:
    ...
    def _encode(
        self, tokenizer: "PreTrainedTokenizer", system: str, history: List[Tuple[str, str]]
    ) -> List[Tuple[List[int], List[int]]]:
        r"""
...
register_template(name="vanilla", prefix=[], prompt=["{{query}}"], system="", sep=[], use_history=False)
...
register_template(name="belle", prefix=["{{system}}"], prompt=["Human: {{query}}\n\nBelle: "], system="", sep=["\n\n"])
...
register_template(name="linly", prefix=["{{system}}"], prompt=["User: {{query}}\nBot: "], system="", sep=["\n"])
...
register_template(name="billa", prefix=["{{system}}"], prompt=["Human: {{query}}\nAssistant: "], system="", sep=["\n"])
...
register_template(
    name="baichuan",
    prefix=["{{system}}"],
    prompt=[{"token": "<reserved_102>"}, "{{query}}", {"token": "<reserved_103>"}],  # user token  # assistant token
    system="",
    sep=[],
    efficient_eos=True,
)
...
register_template(
    name="baichuan2",
    prefix=["{{system}}"],
    prompt=[{"token": "<reserved_106>"}, "{{query}}", {"token": "<reserved_107>"}],  # user token  # assistant token
    system="",
    sep=[],
    efficient_eos=True,
)
